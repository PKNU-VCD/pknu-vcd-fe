    ...
    <>
      ...
      <CommonContainer>
        ...
        <S.CelebrationInfoContainer>
          ...
          <S.ContentContainer>
            <S.ContentTitle>
              한마디 (진심으로 축하드리며, 매우 자랑스럽게 생각합니다.)
            </S.ContentTitle>
            <S.Content>
              미술 전시의 틀을 깨는 졸업 작품들이 유전자 편집 기술로 재구성될 가능성이
              제기되었습니다. 연구에 따르면, 캔버스 위의 시간은 붓 터치 하나로 뒤섞이며, <br />{' '}
              조형물의 형태는 졸업 시즌마다 변주된다고 합니다. 이는 단순한 전시 기획을 넘어
              퍼포먼스적 공간 해체에도 활용될 수 있어, 갤러리 벽이 사라질 날도 <br />
